...
const LeadSourceEnum = z.enum(["WEBSITE", "MANUAL", "WHATSAPP", "INSTAGRAM", "FACEBOOK", "LINKEDIN", "REFERRAL", "WALK_IN", "COLD_CALL", "EMAIL", "OTHER"]);
const LeadStatusEnum = z.enum(["NEW", "ATTENDED", "REQUIREMENT_DISCUSSION", "QUOTATION_SENT", "NEGOTIATION", "QUOTATION_ACCEPTED", "CLIENT_FORM_SENT", "CLIENT_FORM_RECEIVED", "CONVERTED_TO_CLIENT", "PROJECT_CREATED", "FIRST_SHOOT_SCHEDULED", "COMPLETED", "CLOSED_LOST"]);
