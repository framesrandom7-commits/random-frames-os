...
import { QuotationEngine } from "../frontend/domain/finance/quotation-engine";
import { InvoiceEngine } from "../frontend/domain/finance/invoice-engine";
import { PaymentEngine } from "../frontend/domain/finance/payment-engine";
import { PaymentAllocationService } from "../frontend/domain/finance/payment-allocation";
import { ImmutableFinancialLedger } from "../frontend/domain/finance/ledger-engine";
import { ExpenseEngine } from "../frontend/domain/finance/expense-engine";
import { VendorService } from "../frontend/domain/finance/vendor-service";
import { ProjectProfitabilityEngine } from "../frontend/domain/finance/project-profitability";
import { GstTaxEngine } from "../frontend/domain/finance/gst-tax-service";
import { FinanceReportingEngine } from "../frontend/domain/finance/reporting-engine";
import { FinanceWorkflowEngine } from "../frontend/domain/finance/workflow-handlers";
import { FinancialAccountService } from "../frontend/domain/finance/financial-accounts";
import { PaymentGatewayFactory } from "../frontend/domain/finance/gateways/index";
import { FinanceExportService } from "../frontend/domain/finance/export-service";
import { FinanceRbacEngine } from "../frontend/domain/finance/finance-rbac";
import { EventBus } from "../frontend/domain/events/EventBus";
...
async function runFinanceRuntimeCertification() {
  ...
  try {
    ...
    await ExpenseEngine.recordExpense({
